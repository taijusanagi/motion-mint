// This is copied from
// https://etherscan.io/address/0x932a29dbfc1b8c3bdfc763ef53f113486a5b5e7d#code

export const zoraNFTCreatorV1ABI = [
  {
    inputs: [
      { internalType: "address", name: "_implementation", type: "address" },
      { internalType: "contract EditionMetadataRenderer", name: "_editionMetadataRenderer", type: "address" },
      { internalType: "contract DropMetadataRenderer", name: "_dropMetadataRenderer", type: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "editionContractAddress", type: "address" },
      { indexed: false, internalType: "uint256", name: "editionSize", type: "uint256" },
    ],
    name: "CreatedDrop",
    type: "event",
  },
  ...
  },
  {
    ...
    outputs: [{ internalType: "address payable", name: "newDropAddress", type: "address" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "metadataContractURI", type: "string" },
    ],
    name: "createDrop",
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract DropMetadataRenderer", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [{ internalType: "contract EditionMetadataRenderer", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
