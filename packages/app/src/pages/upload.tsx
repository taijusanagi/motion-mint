      ...
      <main className="flex-1 mx-auto w-full max-w-2xl py-12 px-4 relative">
        ...
        <div className="mb-4">
          <div className="border rounded-md bg-default text-default p-4">
            <h3 className="text-lg font-bold text-default mb-1">Account</h3>
            <p className="mb-4 text-xs text-accent">It requires credit to run the AI video-motion conversion.</p>
            {!isConnected && (
              <>
              ...
              <>
                ...
                <div className="mb-4">
                  <div className="border rounded-md bg-default text-default p-4">
                    ...
                    <p className="mb-2 text-default text-xs">Name: MotionMint</p>
                    <p className="mb-2 text-default text-xs">Price: 0.01 ETH</p>
                  </div>
                </div>
